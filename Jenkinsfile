node {
    ...
    stage('Deploy Docker Image and login'){
      ...
      echo "Docker Image Tag Name: ${dockerImageTag}"
        ...
        sh "docker images"
        sh "docker login -u vickeyyvickey -p Geethar@m20" // put PWD
	...
	//sh "read imageid"
	   sh "docker tag 249277328e3d      vibsi/myapplication:latest" //must change your name and tag no
        sh "docker push   vibsi/myapplication"
  }
}
